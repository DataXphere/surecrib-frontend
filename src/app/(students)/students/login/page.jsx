...
const StudentLogin = () => {
  ...
  const { setUserAndTokenData } = useContext(UserContext);
  ...
  const handleSubmit = async (values) => {
    setLoading(true);
    try {
      const response = await fetch("https://surecrib.onrender.com/api/students/signin", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        setUserAndTokenData(data.user, data.token);
